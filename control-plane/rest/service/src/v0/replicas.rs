use super::*;
use common_lib::{
    mbus_api::{message_bus::v0::BusError, timeout_opts},
...
async fn put_replica(
    ...
    let pool_client = PoolClient::init(None, timeout_opts()).await;
    ...
    let client = ReplicaClient::init(None, timeout_opts()).await;
